...
# Percorsi ai file
input_file = "Scrivere_in_modo_sostenibile_usando_il_testo_semplice_con_Pandoc_e_Markdown-Usare_Pandoc_per_convertire_Markdown_in_un_documento_MS_Word.md"   # File Markdown di input
output_file = "Scrivere_in_modo_sostenibile_usando_il_testo_semplice_con_Pandoc_e_Markdown-Usare_Pandoc_per_convertire_Markdown_in_un_documento_MS_WordOUTPUT.md" # File Markdown modificato
